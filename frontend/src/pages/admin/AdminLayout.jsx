...
const NAV = [
  ...
  { to: '/admin/plataformas',     label: 'Plataformas',    icon: IconPlatform,  perm: 'configuracoes.gerenciar' },
  { to: '/admin/ai-assistant',   label: 'IA Assistant',   icon: IconIA,        perm: 'configuracoes.gerenciar' },
  // ── Sistema — itens promovidos ao nível raiz (sem submenu) ──
  ...
  { to: '/admin/setup',          label: 'Setup',          icon: IconSetup,     perm: 'configuracoes.gerenciar' },
