      ...
      <div style={{ display: 'grid', gap: SPACE.md }}>
        {commits.map((c, i) => (
          <div key={i} style={{
            ...
            <div style={{ minWidth: 0 }}>
              <div style={{ fontSize: FONT.base, color: C.text, fontWeight: 600, wordBreak: 'break-word', lineHeight: 1.4 }}>{c.mensagem}</div>
              <div style={{ fontSize: FONT.xs, color: C.muted, marginTop: 3, display: 'flex', gap: SPACE.md, flexWrap: 'wrap' }}>
                <span style={{ fontFamily: 'monospace', color: C.blue }}>{c.sha}</span>
                <span>{c.autor}</span>
